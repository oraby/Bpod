...
%% FS MOD
            ...
            if ~isdir(obj.BpodUserPath)
                %%
                handDialg.d = dialog('Position',[450 350 485 300],'Name','BpodUser directory not found');
                handDialg.txt = uicontrol('Parent',handDialg.d,...
                    'Style','text',...
                    'Position',[50 200 385 40],...
                    'HorizontalAlignment','left',...
                    'String',{'Bpod user directory was not found and will be created.','Choose location:'});
                handDialg.edit = uicontrol('Parent',handDialg.d,...
                    'Style','edit',...
                    'Position',[50 170 385 20],...
                    'HorizontalAlignment','left',...
                    'String',obj.BpodUserPath);
                handDialg.browse = uicontrol('Parent',handDialg.d,...
                    'Style','pushbutton',...
                    'Position',[375 145 60 20],...
                    'Callback',@(s,e)uigetdir(obj.BpodUserPath,'Choose location:'),...
                    'String','Browse');
                %%
                ...
                answer = inputdlg('','Choose location',[1 50],{obj.BpodUserPath})
                warning('on','Bpod:BpodObject')
                warning('Bpod:BpodObject','Bpod user directory not found. Directory created as [%s].', obj.BpodUserPath)
